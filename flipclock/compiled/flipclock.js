        ...
        FlipClock.DailyCounterFace = FlipClock.Face.extend({
            ...
            build: function (i) {
                ...
                (i = i || this.factory.time.getDayCounter(this.showSeconds)).length > s.length && t.each(i, function (t, i) {
                    e.createList(i)
                }), this.showSeconds ? t(this.createDivider("")).insertBefore(this.lists[this.lists.length - 2].$el) : n = 2, t(this.createDivider("")).insertBefore(this.lists[this.lists.length - 4 + n].$el), t(this.createDivider("")).insertBefore(this.lists[this.lists.length - 6 + n].$el), t(this.createDivider("", !0)).insertBefore(this.lists[0].$el), this.base()
            },
            flip: function (t, i) {
